...
public class CheckInsStep {
    ...
    public void userSetNameQuestionSundayMorings(String nameQuestion) {
        check.inputSetQuestion(nameQuestion);
    }
