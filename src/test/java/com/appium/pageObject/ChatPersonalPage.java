...
public class ChatPersonalPage extends BaseTClass {
    ...
    String text;
    public void typeMessageBlank(String textBlank) {
        text = textBlank;
        MobileElement a = typMessage;
        a.isDisplayed();
        a.click();
        a.clear();
        a.sendKeys(textBlank);
    }
    ...
    @AndroidFindBy(xpath = "//android.widget.ImageView[contains(@content-desc,'docx')]/android.view.View | //android.widget.ImageView[contains(@content-desc,'zip')]/android.view.View | //android.widget.ImageView[contains(@content-desc,'mp4')]/android.view.View")
    MobileElement attachDocMenu;

    public void clickAttachMenu() {
        attachDocMenu.click();
    }
